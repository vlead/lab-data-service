...
def populate():
    ...
    inst1.save()
    inst2 = institute_cls(inst_name="College of Engineering, Pune", inst_id="coep")
    inst2.save()
    inst3 = institute_cls(inst_name="Dayalbagh Educational institute_cls",
                          inst_id="dei")
    inst3.save()
    inst4 = institute_cls(inst_name="IIT Bombay", inst_id="iitb")
    inst4.save()
    inst5 = institute_cls(inst_name="IIT Delhi", inst_id="iitd")
    inst5.save()
    inst6 = institute_cls(inst_name="IIT Guwahati", inst_id="iitg")
    inst6.save()
    inst7 = institute_cls(inst_name="IIIT Hyderabad", inst_id="iiith")
    inst7.save()
    inst8 = institute_cls(inst_name="IIT Kanpur", inst_id="iitk")
    inst8.save()
    inst9 = institute_cls(inst_name="IIT Kharagpur", inst_id="iitkgp")
    inst9.save()
    inst10 = institute_cls(inst_name="IIT Madras", inst_id="iitm")
    inst10.save()
    inst11 = institute_cls(inst_name="IIT Roorkee", inst_id="iitr")
    inst11.save()
    ...
    dis2 = discipline_cls(dis_name="Biotechnology and Biomedical Engineering",
                          dis_id="biotech")
    dis2.save()
    dis3 = discipline_cls(dis_name="Chemical Engineering", dis_id="chem-engg")
    dis3.save()
    dis4 = discipline_cls(dis_name="Chemical Sciences", dis_id="chem")
    dis4.save()
    dis5 = discipline_cls(dis_name="Civil Engineering", dis_id="civil")
    dis5.save()
    dis6 = discipline_cls(dis_name="Computer Science and Engineering",
                          dis_id="cse")
    dis6.save()
    dis7 = discipline_cls(dis_name="Electrical Engineering", dis_id="ee")
    dis7.save()
    dis8 = discipline_cls(dis_name="Electronics and Communication", dis_id="ece")
    dis8.save()
    dis9 = discipline_cls(dis_name="Humanities", dis_id="hmt")
    dis9.save()
    dis10 = discipline_cls(dis_name="Mechanical Engineering", dis_id="mech")
    dis10.save()
    dis11 = discipline_cls(dis_name="Physical Sciences", dis_id="phy-sc")
    dis11.save()
    dis12 = discipline_cls(dis_name="Textile Engineering", dis_id="tex-engg")
    dis12.save()
    dis13 = discipline_cls(dis_name="Design Engineering", dis_id="dsgn-engg")
    dis13.save()
    dis14 = discipline_cls(dis_name="Material Sciences", dis_id="mat-sc")
    dis14.save()
