...
* Creation of database
  ...
  - Get the mysql dump file for the given version from
    [[files.vlabs.ac.in/lds]]
    #+BEGIN_EXAMPLE
    wget http://files.vlabs.ac.in/lds/lds-v2.0.0-2017-09-07.sql
    #+END_EXAMPLE
...
* Access the application
  ...
  The application is accessed at =http://localhost:1307=
