...
args = {"__tablename__": "institute",
        ...
        "assets": db.relationship('Asset', secondary=institutes_assets,
                                      backref='institutes'),
        "developers": db.relationship('Developer', backref=\
                                          db.backref('institute'))
       }

Institute = ClassPersistenceTemplate.mk_persistent(Institute, ['inst_id'],\
                                                       ,**args)
...
Discipline = ClassPersistenceTemplate.mk_persistent(Discipline, ['dis_id'],\
                                                        ,**args)
