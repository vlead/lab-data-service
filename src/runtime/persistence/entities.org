...
=======
>>>>>>> 172a7026ec84d939c573bfbc294904c7e0a0ad8b
#+NAME: class_Lab
#+begin_src python
...
=======
                       discipline=discipline, asset=asset)
>>>>>>> 172a7026ec84d939c573bfbc294904c7e0a0ad8b
        lab1.save()
...
=======
                       experiments=[], institute=inst, discipline=discipline, asset=asset)
>>>>>>> 172a7026ec84d939c573bfbc294904c7e0a0ad8b
        lab2.save()
        ...
        self.assertEqual(lab1.get("asset").get("asset_type"), 
        ...
        self.assertEqual(lab2.get("discipline").get("dis_name"), 
                             discipline.get("dis_name"))
        self.assertEqual(lab2.get("asset").get("asset_type"), 
                             asset.get("asset_type"))
