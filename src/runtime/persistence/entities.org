...
#+NAME: class_integrationstatus_association_Table
#+BEGIN_SRC python
labs_integrationstatus = db.Table('labs_integrationstatus',
		      db.Column('lab_id', db.Integer, 
                            db.ForeignKey('lab.id')),
		      db.Column('integration_level', db.Integer,
                            db.ForeignKey('integrationstatus.id')))
