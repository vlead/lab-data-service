...
#+NAME: class_association_Table
#+BEGIN_SRC python
names_info = db.Table('names_info',
		      db.Column('name_id', db.Integer, 
...
#+NAME: class_association_Table
#+BEGIN_SRC python
emails_info = db.Table('emails_info',
...
#+NAME: class_association_Table
#+BEGIN_SRC python
developers_info = db.Table('developers_info',
		      db.Column('name_id', db.Integer, 
                            db.ForeignKey('name.id')),
		      db.Column('email_id', db.Integer,
                            db.ForeignKey('email.id')))
...
Developer = ClassPersistenceTemplate.mk_persistent(Developer, ['email'], **args)
...
class TestPersistentDeveloper(TestCase):
    ...
    def test_create_dev(self):
        ...
        self.assertEqual(dev.get("name"), dev_name)
        self.assertEqual(dev.get("email"), email_id)
