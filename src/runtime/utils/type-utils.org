...
** Url predicate
    ...
    (We may want to instead use the =validate_url= package of Python.)
...
class TestCheckUrl(TestCase):
    ...
    def test_check_url(self):
        ...
        self.assertEqual(check_url("http://cse14-iiith.vlabs.ac.in/Introduction.html?domain=Computer%20Science"),
                             "http://cse14-iiith.vlabs.ac.in/Introduction.html?domain=Computer%20Science")
        self.assertRaises(TypeError, check_url, "htp://abc-56/xyz")
