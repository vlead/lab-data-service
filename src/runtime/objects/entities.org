...
def are_hostinginfos(hostinginfos):
    ret_val = True
    if is_list(hostinginfos):
        for hostinginfo in hostinginfos:
            if not is_hostinginfo(hostinginfo):
                ret_val = False
    else:
        ret_val = False
...
Lab.add_attributes(lab_name=is_str,
                    ...
                    assets=are_assets,
                    integrationstatus=is_integrationstatus,
                    experiments=are_experiments,
                    developers=are_developers,
                    hostinginfos=are_hostinginfos)
...
Lab.__eq__ = lambda self, other: \
                  ...
                  self.get("integrationstatus") == other.get("integrationstatus") and \
                  self.get("experiments") == other.get("experiments") and \
                  self.get("developers") == other.get("developers") and \
                  self.get("hostinginfos") == other.get("hostinginfos")
...
class TestLab(TestCase):
    ...
    def test_object_lab(self):
        ...
        experiment = Experiment(exp_name=exp_name, exp_id=exp_id, \
                                overview=overview, sections=[], institute=inst, 
        ...
        lab = Lab(lab_name=lab_name, lab_id=lab_id, overview=overview,
                      ...
                      hostinginfos=[host], experiments=[experiment])
        ...
        self.assertEqual(lab.get("institute").get("inst_name"), 
                             inst.get("inst_name"))
        self.assertEqual(lab.get("discipline").get("dis_name"), 
        ...
        self.assertEqual(lab.get("integrationstatus").get("integration_level"), 
                             integrationstatus.get("integration_level"))
        ...
        self.assertEqual(lab.get("hostinginfos")[0].get("hosting_status"), 
...
class TestExperiment(TestCase):
    ...
    def test_object_experiment(self):
        ...
        self.assertEqual(experiment.get("discipline").get("dis_name"), 
                             discipline.get("dis_name"))
        self.assertEqual(experiment.get("developers")[0].get("email").get("email"), email_id.get("email"))
        self.assertEqual(experiment.get("hostinginfos")[0].get("hosting_status"), host.get("hosting_status"))
...
Asset.__eq__ = lambda self, other: \
                  ...
                  self.get("asset_type") == other.get("asset_type") and \
                  self.get("discipline") == other.get("discipline") and \
...
class TestAsset(TestCase):
    ...
    def test_object_asset(self):
        ...
        self.assertEqual(asset.get("institute").get("inst_name"), 
                             inst.get("inst_name"))
        self.assertEqual(asset.get("discipline").get("dis_name"), 
                             discipline.get("dis_name"))
#+end_src
