...
def add_lab():
    ...
    if request.method == 'POST':
        ...
        try:
            q1 = SystemInterface.add_lab(data_dict)
...
def update_and_delete_lab(id):
    ...
    if request.method == 'PUT':
        ...
        try:
            l1 = SystemInterface.update_lab(data_dict)
            return jsonify('{"status":"sucess"}')
    ...
    if request.method == 'DELETE':
        ...
        try:
            q1 = SystemInterface.delete_lab(id)
            return jsonify('{"status":"sucess"}')
...
def update_and_delete_experiment(id):
    ...
    if request.method == 'PUT':
        ...
        try:
            l1 = SystemInterface.update_experiment(data_dict)
            return jsonify('{"status":"sucess"}')
