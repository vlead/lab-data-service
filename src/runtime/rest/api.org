...
def get_and_add_lab():
    if request.method == 'GET':
        if 'lab_id' in request.args:
            ...
            try:
                current_app.logger.debug("execute get_lab_by_labid")
                lab = SystemInterface.get_lab(lab_id)
                current_app.logger.debug("executed get_lab_by_labid")
                return jsonify(lab)
...
#+BEGIN_SRC python
@api.route('/labs', methods=['GET', 'PUT', 'DELETE'])
...
** Get and Add Name
REST API to get and add Name.
#+NAME: get_and_add_name
#+BEGIN_SRC python
@api.route('/names', methods=['GET', 'POST'])
def get_and_add_name():
    if request.method == 'GET':
        try:
...
class TestGetName(TestCase):
    ...
    def test_get_name(self):
        ...
        response = self.client.post("/name", data=json.dumps(payload),
                                 headers=headers)
...
def update_and_delete_name(id):
    if request.method == 'GET':
        try:
            ...
            error_message = "No name found with id: %s found." % id
...
class TestUpdateName(TestCase):
    ...
    def test_update_name(self):
        ...
        payload = {'name': 'Prof. Dharamaraj',
                   'key': KEY}

        payload1 = {'name': 'Prof. Raja',
                   'key': KEY}
...
** Get and Add Email
REST API to get and add Email.
#+NAME: get_and_add_email
#+BEGIN_SRC python
@api.route('/emails', methods=['GET', 'POST'])
def get_and_add_email():
    if request.method == 'GET':
        try:
            names = SystemInterface.get_emails()
...
class TestGetEmail(TestCase):
    ...
    def test_get_email(self):
        print "test_get_email_in_rest"

        payload = {'name': 'abc@gmail.com',
                   'key': KEY}

        headers = {'Content-Type': 'application/json'}

        response = self.client.post("/email", data=json.dumps(payload),
                                 headers=headers)
...
** Update and Delete Email
#+NAME: update_and_delete_email
#+BEGIN_SRC python
@api.route('/emails/<id>', methods=['GET', 'PUT', 'DELETE'])
def update_and_delete_email(id):
    if request.method == 'GET':
        try:
            email = SystemInterface.get_email_by_id(id)
            return jsonify(email)

        except NotFoundError as err:
            error_message = "No email found with id: %s found." % id
    ...
    if request.method == 'PUT':
        ...
        try:
            email = SystemInterface.update_email(data_dict)
            return jsonify(email)
    ...
    if request.method == 'DELETE':
        ...
        try:
            email = SystemInterface.delete_email(id)
            return jsonify({"status":"sucess"})
...
class TestUpdateEmail(TestCase):
    ...
    def test_update_email(self):
        ...
        payload = {'email': 'dharamaraj@gmail.com',
                   'key': KEY}

        payload1 = {'email': 'raja@gmail.com',
                   'key': KEY}
        ...
        response = self.client.put("/emails/1", data=json.dumps(payload1),
                                 headers=headers)
...
class TestDeleteEmail(TestCase):
    ...
    def test_delete_email(self):
        ...
        response = self.client.delete("/emails/1", headers=headers)

        self.assertEqual(response.status_code, 200)

 #+END_SRC
   
** Get and Add Developer
REST API to get and add developer.
#+NAME: get_and_add_developer
#+BEGIN_SRC python
@api.route('/developers', methods=['GET', 'POST'])
def get_and_add_developer():
    if request.method == 'GET':
        try:
    ...
    if request.method == 'POST':
        ...
        try:
            exp = SystemInterface.add_developer(data_dict)
            return jsonify(exp)
...
class TestAddDeveloper(TestCase):
    ...
    def test_add_developer(self):
        ...
        payload = {'dev_name': 'Prof. ABC',
                   'dev_email': 'abc@gmail.com',
                   'key': KEY}
...
** Update and Delete Developer
#+NAME: update_and_delete_developer
#+BEGIN_SRC python
@api.route('/developers/<id>', methods=['GET', 'PUT', 'DELETE'])
def update_and_delete_developer(id):
    if request.method == 'GET':
        try:
            developer = SystemInterface.get_developer_by_id(id)
            return jsonify(developer)

        except NotFoundError as err:
            error_message = "No developer found with id: %s found." % id
    ...
    if request.method == 'DELETE':
        ...
        try:
            developer = SystemInterface.delete_developer(id)
            return jsonify({"status":"sucess"})
...
class TestUpdateDeveloper(TestCase):
    ...
    def test_update_developer(self):
        ...
        response = self.client.put("/developers/1", data=json.dumps(payload1),
                                 headers=headers)
...
class TestDeleteDeveloper(TestCase):
    ...
    def test_delete_developer(self):
        ...
        response = self.client.delete("/developers/1", headers=headers)
...
def get_and_add_institute():
    ...
    if request.method == 'POST':
        ...
        try:
            inst = SystemInterface.add_institute(data_dict)
            return jsonify(inst)
...
#+BEGIN_SRC python
@api.route('/institutes/<id>', methods=['GET', 'PUT', 'DELETE'])
def update_and_delete_institute(id):
    if request.method == 'GET':
        try:
            section = SystemInterface.get_institute_by_id(id)
            return jsonify(section)

        except NotFoundError as err:
            error_message = "No institute found with id: %s found." % id
    ...
    if request.method == 'DELETE':
        ...
        try:
            institute = SystemInterface.delete_institute(id)
...
class TestUpdateInstitute(TestCase):
    ...
    def test_update_institute(self):
        ...
        response = self.client.put("/institutes/1", data=json.dumps(payload1),
                                 headers=headers)
...
class TestDeleteInstitute(TestCase):
    ...
    def test_delete_institute(self):
        ...
        response = self.client.delete("/institutes/1", headers=headers)
...
<<get_and_add_name>>
<<get_and_add_email>>
<<get_and_add_developer>>
<<update_and_delete_name>>
<<update_and_delete_email>>
<<update_and_delete_developer>>
