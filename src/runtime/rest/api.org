...
#+BEGIN_EXAMPLE
{
  ...
  "developers": [
    {
      "email": {
        "email": "dharamrajuu@gmail.com", 
        "id": 3
      }, 
      "id": 3, 
      "name": {
        "id": 3, 
        "name": "Prof. Dharamrajuu"
      }
    }
  ], 
  "discipline": {
...
{"lab_name": "Data Structures",
                   ...
                   "overview" : "overview",
                  "experiments":["ece01"],
                  "developers":["dharamraj@gmail.com"],
                  "hosting_info":["http://cse14-iiith.vlabs.ac.in"],
                  "integration_level": 4,
                   "key": "<key>"
                  }
...
** Get Hosting_Info and Get Hosting_Info
*** API Design
...
def get_hosting_info():
    if request.method == 'GET':
       if 'hosted_url' in request.args:
           ...
           try:
               hosting_info = SystemInterface.get_hosting_info(hosted_url)
...
** Get Integration_Status and Get Integration_Status
*** API Design
...
def get_integration_status():
    if request.method == 'GET':
       if 'integration_level' in request.args:
           ...
           try:
               integration_status = SystemInterface.get_integration_status(integration_level)
    ...
    if request.method == 'DELETE':
        if 'hosted_url' in request.args and 'key' in request.args:
            ...
            try:
                ...
                return jsonify({"status":"sucess"})(data_dict)
...
**** Delete integration_status by integration_level
  ...
  :END:    
  - URL :: /integration_status?<integration_level>&key=<key>
