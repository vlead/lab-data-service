...
class TestGetLabsbyAsset(TestCase):
    ...
    def test_get_labs_by_asset(self):
        print "test_get_labs_by_asset_in_rest"
        ...
        response = self.client.get("/labs?asset_type=image",
                                       headers=headers)
        self.assertEqual(response.status_code, 200)
...
**** Get all Sections
  ...
  - Success Response
    + Status_Code: 200
      + Contents :
#+BEGIN_EXAMPLE
[{"name": "Assignment", "id": "8"}, {"name": "Experiment", "id": "6"}, {"name": "Illustration", "id": "4"}, {"name": "Introduction", "id": "1"}, {"name": "Objective", "id": "2"}, {"name": "Observations", "id": "7"}, {"name": "Procedure", "id": "5"}, {"name": "References", "id": "9"}, {"name": "Theory", "id": "10"}, {"name": "Tutorial", "id": "3"}]
#+END_EXAMPLE    
  - Error Response:
    + Contents :
                {"status" : "error"}
...
**** Get Hosting_Info by hosted_url
  ...
  :END:    
  - URL :: /hosting_info?hosted_url=<hosted_url>
...
#+END_EXAMPLE	       
  ...
  - Example:
#+BEGIN_EXAMPLE
http://localhost:5000/hosting_info?hosted_url=http://cse14-iiith.ac.in
#+END_EXAMPLE
*** Implementation
...
**** Get IntegrationStatus by integration_level
  :PROPERTIES:
  :CUSTOM_ID: api_get_integration_status_by_integration_level
  :END:    

  - URL :: /integration_status?integration_level=<integration_level>
...
#+END_EXAMPLE	       
  ...
  - Example:
#+BEGIN_EXAMPLE
http://localhost:5000/integration_status?integration_level=5
#+END_EXAMPLE
*** Implementation
...
"institute_id": "IITK", "discipline_id": "CSE"}, {"name":"Prof. Pallavi Pawar", 
"email": "pallavi.pawar@gmail.com", "institute_id": "IITK", "discipline_id": "CSE"}],
...
class TestUpdateExperiment(TestCase):
    ...
    def test_update_experiment(self):
        ...
        payload1 = {'institute_name': 'IIT Kharagpur',
                   'institute_id': 'IITKgp',
                   'assets': ['vlabs.ac.in/images/static/image.png'],
                   'key': KEY}
...
class TestUpdateDeveloper(TestCase):
    ...
    def test_update_developer(self):
        ...
        payload1 = {'institute_name': 'IIT Kharagpur',
                    'institute_id': 'IITKgp',
                    'assets': ['vlabs.ac.in/images/video/logo.png'],
                    'key': KEY}
