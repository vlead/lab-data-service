...
def get_developer():
    if request.method == 'GET':
       if 'email_id' in request.args:
           ...
           try:
               developer = SystemInterface.get_developer(email_id)
...
**** Update developers by email_id
  ...
  :END:    
  - URL :: /developers?email_id=<email_id>
...
def update_developer():
    if request.method == 'PUT':
        ...
        if 'email_id' in request.args:
            data_dict['email_id']  = request.args['email_id']
        else:
            abort(500, "Please provide the 'email_id' to update the developer")
...
class TestUpdateDeveloper(TestCase):
    ...
    def test_update_developer(self):
        ...
        response = self.client.put("/developers?email_id=dharamraj@gmail.com", data=json.dumps(payload1),
                                 headers=headers)
...
def delete_developer():
    if request.method == 'DELETE':
        if 'email_id' in request.args and 'key' in request.args:
            email_id  = request.args['email_id']
            key = request.args['key']

            try:
                developer = SystemInterface.delete_developer(email_id, key)
                return jsonify({"status":"sucess"})
...
class TestDeleteDeveloper(TestCase):
    ...
    def test_delete_developer(self):
        ...
        response = self.client.delete("/emails?email_id=dharamraj@gmail.com&key=defaultkey",
                                          headers=headers)
