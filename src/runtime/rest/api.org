...
**** Delete lab by lab_id
  :PROPERTIES:
  :CUSTOM_ID: delete_lab_by_lab_id
  :END:    
...
class TestDeleteLab(TestCase):
    ...
    def test_delete_lab(self):
        ...
        response = self.client.delete("/labs?lab_id=cse02&key=<key>",
                                          headers=headers)
...
**** Update experiment by expid
  :PROPERTIES:
  :CUSTOM_ID: update_experiment_by_expid
  :END:    
...
**** Delete experiment by exp_id
  :PROPERTIES:
  :CUSTOM_ID: delete_experiment_by_exp_id
  :END:    
...
class TestDeleteExperiment(TestCase):
    ...
    def test_delete_experiment(self):
        ...
        response = self.client.delete("/experiments/exp_id=exp123&key=<key>",
                                          headers=headers)
...
**** Update institutes by instid
  :PROPERTIES:
  :CUSTOM_ID: update_institutes_by_instid
  :END:    
...
**** Delete institute by inst_id
  :PROPERTIES:
  :CUSTOM_ID: delete_institute_by_inst_id
  :END:    
...
class TestDeleteInstitute(TestCase):
    ...
    def test_delete_institute(self):
        ...
        response = self.client.delete("/institutes?inst_id=IITKgp&key=<key>", headers=headers)
...
**** Update disciplines by disid
  :PROPERTIES:
  :CUSTOM_ID: update_disciplines_by_disid
  :END:    
...
class TestDeleteDiscipline(TestCase):
    ...
    def test_delete_discipline(self):
        ...
        response = self.client.delete("/disciplines?dis_id=CSE&key=<key>", headers=headers)
