...
** Update and Delete Lab
  :PROPERTIES:
  :CUSTOM_ID: update_and_delete_lab
  :END: 
...
** Get and Add Experiment
  :PROPERTIES:
  :CUSTOM_ID: get_and_add_experiment
  :END: 
...
** Update and Delete Experiment
  :PROPERTIES:
  :CUSTOM_ID: update_and_delete_experiment
  :END: 
...
** Update and Delete Section
  :PROPERTIES:
  :CUSTOM_ID: update_and_delete_section
  :END: 
