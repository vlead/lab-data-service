...
#+BEGIN_SRC python
    def test_lab_exists(self):
        ...
        lab = Lab(lab_name=lab_name1, lab_id=lab_id1, overview=overview1,
                      institute=inst, discipline=discipline, asset=asset,
                      experiments=[], integrationstatus=integrationstatus)
...
#+BEGIN_SRC python
    def test_update_lab(self):
         ...
         lab = Lab(lab_name=lab_name, lab_id=lab_id, overview=overview, 
                       institute=inst, discipline=discipline, asset=asset, 
                       experiments=experiments, integrationstatus=integrationstatus)
...
#+BEGIN_SRC python
    def add_assets_to_lab(self, labid, assets):
        lab = self.get_lab_by_id(labid)
        asset_list = []
        for asset in assets:
...
#+BEGIN_SRC python
    def test_add_saved_assets_to_lab(self):
         ...
         lab1 = self.persistence_delegate.add_assets_to_lab(lab1.id, \
                                                             [asset])
...
#+BEGIN_SRC python
    ...
    def test_get_lab_with_given_lab_id(self):
         ...
         lab1 = Lab(lab_name=lab_name1, lab_id=lab_id1, overview=overview, \
                        institute=inst, discipline=discipline, asset=asset, \
                        experiments=[], integratiostatus=integrationstatus)
         lab1.save()
