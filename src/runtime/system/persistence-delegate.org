...
* Persistence Delegate
  :PROPERTIES:
  :CUSTOM_ID: persistence_delegate
  :END: 
...
** Initialize Persistence Delegate
  :PROPERTIES:
  :CUSTOM_ID: initialize_persistence_delegate
  :END: 
   Provides all the delegates that operate on objects.

*** class_persistence_delegate 
  :PROPERTIES:
  :CUSTOM_ID: class_persistence_delegate
  :END: 
...
*** Tests
  :PROPERTIES:
  :CUSTOM_ID: test_class_persistence_delegate
  :END: 
...
***  Check if =lab= already exists
  :PROPERTIES:
  :CUSTOM_ID: persistence_lab_exists
  :END: 
...
***  Check if =experiment= already exists
  :PROPERTIES:
  :CUSTOM_ID: persistence_experiment_exists
  :END: 
...
***  Check if =section= already exists
  :PROPERTIES:
  :CUSTOM_ID: persistence_section_exists
  :END: 
...
***  Add experiment to the system
  :PROPERTIES:
  :CUSTOM_ID: persistence_add_experiment
  :END: 
...
***  Add section to the system
  :PROPERTIES:
  :CUSTOM_ID: persistence_add_section
  :END: 
...
**** Tests
  :PROPERTIES:
  :CUSTOM_ID: test_persistence_update_lab
  :END: 
...
***  Update Experiment 
  :PROPERTIES:
  :CUSTOM_ID: persistence_update_experiment
  :END: 
...
**** Tests
  :PROPERTIES:
  :CUSTOM_ID: test_persistence_update_section
  :END: 
...
***  Delete lab 
  :PROPERTIES:
  :CUSTOM_ID: persistence_delete_lab
  :END: 
...
***  Delete Experiment 
  :PROPERTIES:
  :CUSTOM_ID: persistence_delete_experiment
  :END: 
...
***  Delete Section 
  :PROPERTIES:
  :CUSTOM_ID: persistence_delete_section
  :END: 
...
***  Add experiments to a Lab
  :PROPERTIES:
  :CUSTOM_ID: persistence_add_experiments_to_lab
  :END: 
...
***  Add sections to a Experiment
  :PROPERTIES:
  :CUSTOM_ID: persistence_add_sections_to_experiment
  :END: 
...
***  Get an object
  :PROPERTIES:
  :CUSTOM_ID: persistence_get_object
  :END: 
...
***  Get Section
  :PROPERTIES:
  :CUSTOM_ID: persistence_get_section
  :END: 
...
***  Get Experiment
  :PROPERTIES:
  :CUSTOM_ID: persistence_get_experiment
  :END: 
...
***  Get Lab By ID
  :PROPERTIES:
  :CUSTOM_ID: persistence_get_lab_by_id
  :END: 
...
***  Get Experiment By ID
  :PROPERTIES:
  :CUSTOM_ID: persistence_get_experiment_by_id
  :END: 
