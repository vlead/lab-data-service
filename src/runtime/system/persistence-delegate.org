...
#+BEGIN_SRC python
    def update_developer(self, dev, dev_name, email_id):
        dev.set(name=dev_name, email=email_id)
        dev.save()
        return dev
...
#+BEGIN_SRC python
    def test_update_developer(self):
         ...
         dev_name1.save()
         email_id1 = Email(email="raja@maths.iitd.ac.in")
         email_id1.save()
         dev2 = self.persistence_delegate.update_developer(dev1, dev_name1, email_id1)

         self.assertEqual(dev1.get("name").get("name"), dev_name1.get("name"))
         self.assertEqual(dev1.get("email").get("email"), email_id1.get("email"))
