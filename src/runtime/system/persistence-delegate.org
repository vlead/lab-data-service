...
#+BEGIN_SRC python
    def test_update_institute(self):
         ...
         inst_name1 = "IIT Kanpur"
         inst_id1 = "IITK"
         institute2 = Institute(inst_name=inst_name1, inst_id=inst_id1)
         institute2 = self.persistence_delegate.update_institute\
           (institute1, inst_name1, inst_id1),
         institute2 = Institute.get_by_id(1)

         self.assertEqual(institute2.get("inst_name"), inst_name1)
         self.assertEqual(institute2.get("inst_id"), inst_id1)
