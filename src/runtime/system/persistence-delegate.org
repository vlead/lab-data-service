...
#+BEGIN_SRC python
    def test_add_asset_type(self):
         ...
         asset_type1 = AssetType(asset_type="Image")
         asset1 = self.persistence_delegate.add_asset_type(asset_type1)
         
         asset_type2 = AssetType(asset_type="Video")
         
         asset_type1 = AssetType.get_by_id(1)

         self.assertEqual(self.persistence_delegate.asset_exists(asset_type1),
                          True)
         self.assertEqual(self.persistence_delegate.asset_exists(asset_type2),
                          False)
#+END_SRC
