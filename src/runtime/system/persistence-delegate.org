...
#+BEGIN_SRC python
    def test_lab_exists(self):
        ...
        dis_name = "IIT Kanpur"
        dis_id = "IITK"
        discipline = Discipline(dis_name=dis_name, dis_id=dis_id, assets=[asset])
        discipline.save()
...
#+BEGIN_SRC python
    def test_experiment_exists(self):
        ...
        experiment1 = Experiment(exp_name=exp_name1, exp_id=exp_id1,
                                 ...
                                 discipline=discipline, 
                                 integration_status=integration_status, assets=[asset],
                                 developers=[dev], hosting_info=[host])
...
#+BEGIN_SRC python
    def test_hosting_info_exists(self):
        ...
        hosted_on1 = "cloud"
        hosting_info1 = HostingInfo(hosting_status=hosting_status1, hosted_url=hosted_url1, hosted_on=hosted_on1)
        ...
        hosted_on2 = "server"
        hosting_info2 = HostingInfo(hosting_status=hosting_status2, hosted_url=hosted_url2, hosted_on=hosted_on2)
...
#+BEGIN_SRC python
    def integration_status_exists(self, integration_status):
        ...
        return integration_status == self.get_integration_status(integration_level=integration_level)
...
#+BEGIN_SRC python
    def test_integration_status_exists(self):
        ...
        intstatus1 = self.persistence_delegate.add_integration_status(integration_status1)
...
#+BEGIN_SRC python
    def test_add_institute(self):
         ...
         inst_name1 = "IIT Kanpur"
         inst_id1 = "IITK"
         institute1 = Institute(inst_name=inst_name1, inst_id=inst_id1, assets=[asset])                             
         institute1 = self.persistence_delegate.add_institute(institute1)
         
         inst_name2= "IIT Kharagpur"
         inst_id2= "IITKgp"
         institute2 = Institute(inst_name=inst_name2, inst_id=inst_id2, assets=[asset]) 
...
#+BEGIN_SRC python
    def update_lab(self, lab, lab_name, overview, institute, discipline,
                         integration_status):
        lab.set(lab_name=lab_name, overview=overview, institute=institute, discipline=discipline,
                integration_status=integration_status)
        lab.save()
        return lab
...
#+BEGIN_SRC python
    def test_update_lab(self):
         ...
         inst_id1 = "IITKgp"
         inst1 = Institute(inst_name=inst_name1, inst_id=inst_id1, assets=[asset])
         inst1.save()

         dis_name1 = "Computer Science & Engineering"
         dis_id1 = "IIT Kharagpur"
         discipline1 = Discipline(dis_name=dis_name1, dis_id=dis_id1, assets=[asset])
         discipline1.save()
         ...
         lab2 = self.persistence_delegate.update_lab\
           (lab1, lab_name1, overview1, inst1, discipline1, integration_status1),
         ...
         self.assertEqual(lab2.get("integration_status").get("integration_level"), 
...
#+BEGIN_SRC python
    def update_experiment(self, experiment, exp_name, overview, institute, 
                          discipline, integration_status):
        experiment.set(exp_name=exp_name, overview=overview, institute=institute, 
                       discipline=discipline, integration_status=integration_status)
        experiment.save()
        return experiment
...
#+BEGIN_SRC python
    def test_update_experiment(self):
         ...
         inst_name1 = "IIT Kharagpur"
         inst_id1 = "IITKgp"
         inst1 = Institute(inst_name=inst_name1, inst_id=inst_id1, assets=[asset1])
         inst1.save()

         dis_name1 = "Electronics and Communication"
         dis_id1 = "ece"
         discipline1 = Discipline(dis_name=dis_name1, dis_id=dis_id1, assets=[asset1])
         discipline1.save()
         ...
         self.assertEqual(exp2.get("institute").get("inst_id"), 
                              inst1.get("inst_id"))
         self.assertEqual(exp2.get("discipline").get("dis_id"), 
                              discipline1.get("dis_id"))
         self.assertEqual(exp2.get("integration_status").get("integration_level"), 
                              integration_status1.get("integration_level"))
...
#+BEGIN_SRC python
    def test_update_discipline(self):
         ...
         dis_name = "IIT Delhi"
         dis_id = "EEE08"
         dis = Discipline(dis_name=dis_name, dis_id=dis_id, assets=[asset])
         dis1 = self.persistence_delegate.add_discipline(dis)
...
#+BEGIN_SRC python
    def update_developer(self, dev, dev_name, institute, discipline):
        dev.set(name=dev_name, institute=institute, discipline=discipline)
        dev.save()
        return dev
...
#+BEGIN_SRC python
    def test_update_developer(self):
         ...
         dev2 = self.persistence_delegate.update_developer(dev1, dev_name1, inst1, discipline1)

         self.assertEqual(dev1.get("name").get("name"), dev_name1.get("name"))
         self.assertEqual(dev1.get("institute").get("inst_id"), 
                              inst1.get("inst_id"))
         self.assertEqual(dev1.get("discipline").get("dis_id"), 
                              discipline1.get("dis_id"))
...
#+BEGIN_SRC python
    def test_update_institute(self):
         ...
         inst_name = "IIT Delhi"
         inst_id = "IITD"
         institute = Institute(inst_name=inst_name, inst_id=inst_id, assets=[asset])
...
#+BEGIN_SRC python
    def test_update_hosting_info(self):
         ...
         hosted_url = "http://cse14-iiith.vlabs.ac.in"
         hosted_on = "cloud"
         hosting_info = HostingInfo(hosting_status=hosting_status, hosted_url=hosted_url, hosted_on=hosted_on)
         hosting_info1 = self.persistence_delegate.add_hosting_info(hosting_info)
...
#+BEGIN_SRC python
    def test_delete_discipline(self):
         ...
         dis_id1 = "EEE10"
         dis1 = Discipline (dis_name=dis_name1, dis_id=dis_id1, assets=[asset])
...
#+BEGIN_SRC python
    def test_delete_hosting_info(self):
         ...
         hosted_on1 = "server"
         hosting_info1 = HostingInfo(hosting_status=hosting_status1, hosted_url=hosted_url1, hosted_on=hosted_on1)
         hosting_info2 = self.persistence_delegate.add_hosting_info(hosting_info1)

         self.persistence_delegate.delete_hosting_info("http://cse14-iiith.vlabs.ac.in")
...
#+BEGIN_SRC python
    def test_delete_integration_status(self):
         ...
         integration_level = 4
         integration_status = IntegrationStatus(integration_level=integration_level)                    
         integration_status1 = self.persistence_delegate.add_integration_status(integration_status)

         integration_level1 = 2
         integration_status1 = IntegrationStatus(integration_level=integration_level1)
         integration_status2 = self.persistence_delegate.add_integration_status(integration_status1)
...
#+BEGIN_SRC python
    def test_get_integration_status(self):
         ...
         intstatus.save()
         intstatus_obj = self.persistence_delegate.get_integration_status(integration_level=
