...
#+BEGIN_SRC python
    def update_lab(self, lab, lab_name, overview, institute, discipline,
                         integration_status, hosting_info, developers, assets):
        lab.set(lab_name=lab_name, overview=overview, institute=institute, 
                    discipline=discipline, hosting_info=hosting_info,
                    integration_status=integration_status,
...
#+BEGIN_SRC python
    def update_discipline(self, discipline, dis_name, assets):
        discipline.set(dis_name=dis_name, assets=assets)
        discipline.save()
        return discipline
...
#+BEGIN_SRC python
    def update_institute(self, institute, inst_name, assets):
        institute.set(inst_name=inst_name, assets=assets)
        institute.save()
        return institute
