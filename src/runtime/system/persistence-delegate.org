...
#+BEGIN_SRC python
    def experiment_exists(self, cls_name, id):
        ret_val = False
...
#+BEGIN_SRC python
    def institute_exists(self, instid):
        ret_val = False

        try:
            if Institute.get_by_id(instid) is not None:
                ret_val = True
        except Exception as e:
            pass
...
#+BEGIN_SRC python
    def developer_exists(self, email):
        ret_val = False
        try:
            if self.get_developer(email=email) is not None:
                ret_val = True
        except Exception as e:
            pass
...
#+BEGIN_SRC python
    def test_developer_exists(self):
        ...
        self.assertEqual(self.persistence_delegate.developer_exists(developer1.get("email")), True)
        self.assertEqual(self.persistence_delegate.developer_exists\
                             (developer2.get("email").get("email")), False)
#+END_SRC
...
#+BEGIN_SRC python
    def add_developer(self, developer):
        if self.developer_exists(developer):
            developer = self.get_developer(email=developer.get('email').get('email'))
        else:
            developer.save()
...
#+BEGIN_SRC python
    def test_add_institute(self):
         ...
         self.assertEqual(self.persistence_delegate.institute_exists(institute1.id),
                          True)
         self.assertEqual(self.persistence_delegate.institute_exists(institute2.id),
                          False)
...
#+BEGIN_SRC python
    def update_institute(self, institute, inst_name, inst_id):
        institute.set(inst_name=inst_name, inst_id=inst_id)
        institute.save()
        return institute
...
#+BEGIN_SRC python
    def test_update_institute(self):
         ...
         inst1 = self.persistence_delegate.add_institute(inst)

         inst_name1 = "IIT Kanpur"
         inst_id1 = "IITK"
         inst2 = Institute(inst_name=inst_name1, inst_id=inst_id1)

         inst2 = Institute.get_by_id(1)

         self.assertEqual(inst2.get("inst_name1"), inst_name1)
...
#+BEGIN_SRC python
    def delete_institute(self, i_id):
        record = Institute.get_by_id(i_id)
        if not record:
            abort(404, 'No Institute with id %s' % (i_id))
        else:
            try:
                record.delete()
                #db.session.delete(record)
...
#+BEGIN_SRC python
    def test_delete_institute(self):
         ...
         inst_id1 = "IITKgp"
         inst1 = Institute(inst_name=inst_name, inst_id=inst_id) 
         inst2 = self.persistence_delegate.add_institute(inst1)

         self.persistence_delegate.delete_institute(1)
...
#+BEGIN_SRC python
    def test_get_institute(self):
         ...
         inst_obj = self.persistence_delegate.get_institute(inst_name=
                                                inst.get("inst_name"))
         self.assertEqual(inst_obj.get("inst_name"),
                              inst.get("inst_name"))
#+END_SRC
...
#+BEGIN_SRC python
    def test_get_institute_by_id(self):
         ...
         self.assertEqual(inst_obj.get("inst_id"),
                              inst_id)
