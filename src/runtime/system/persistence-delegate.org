...
#+BEGIN_SRC python
    def test_lab_exists(self):
        ...
        lab_id1="CSE01"
        experiments=[]
        lab = Lab(lab_name=lab_name1, lab_id=lab_id1, experiments=experiments)

        lab1 = self.persistence_delegate.add_lab(lab)

        lab_name2="Data Structures"
        lab_id2="CSE02"
        lab2 = Lab(lab_name=lab_name2, lab_id=lab_id2, experiments=experiments)
...
#+BEGIN_SRC python
    def update_lab(self, lab, lab_name, lab_id, experiments):
        lab.set(lab_name=lab_name, lab_id=lab_id, experiments=experiments)
        lab.save()
        return lab
...
#+BEGIN_SRC python
    def test_update_lab(self):
         ...
         lab_id = "cse01"
         experiments = []
         lab = Lab(lab_name=lab_name, lab_id=lab_id, experiments=experiments)
         
         lab1 = self.persistence_delegate.add_lab(lab)
         lab_name1 = "Computer Programming"
         lab_id1 = "cse02"
         lab2 = self.persistence_delegate.update_lab\
           (lab1, lab_name1, lab_id1, experiments),
...
#+BEGIN_SRC python
    def test_delete_lab(self):
         ...
         lab_name1 = "Computer Programming"
         lab_id1 = "cse02"
         lab1 = Lab(lab_name=lab_name1, lab_id=lab_id1, experiments=[])
