...
#+BEGIN_SRC python
    ...
    def name_exists(self, id):
        ret_val = False
        try:
            if Name.get_by_id(id) is not None:
                ret_val = True
        except Exception as e:
            pass
...
#+BEGIN_SRC python
    ...
    def email_exists(self, email):
        ret_val = False
        try:
            if Email.get_by_id(email) is not None:
                ret_val = True
        except Exception as e:
            pass
...
#+BEGIN_SRC python
    ...
    def developer_exists(self, dev_email):
        ret_val = False
        try:
            if Developer.get_by_id(dev_email) is not None:
                ret_val = True
        except Exception as e:
            pass
