...
#+BEGIN_SRC python
    def test_add_hosting_info(self):
         ...
         hosting_info1 = HostingInfo(hosting_status=hosting_status1,
                                         hosted_url=hosted_url1,
                                         hosted_on=hosted_on1)
         hosting_info1 = self.persistence_delegate.
         add_hosting_info(hosting_info1)
...
#+BEGIN_SRC python
    def test_add_integration_status(self):
         ...
         integration_status1 = IntegrationStatus(integration_level=
                                                     integration_level1)
         integration_status1 = self.persistence_delegate.
...
#+BEGIN_SRC python
    def test_update_developer(self):
         ...
         self.assertEqual(dev1.get("name").get("name"),
                              dev_name1.get("name"))
...
#+BEGIN_SRC python
    def test_delete_integration_status(self):
         ...
         integration_status = IntegrationStatus(integration_level=
                                                    integration_level)                    
         integration_status1 = self.persistence_delegate.\
         add_integration_status(integration_status)
         ...
         self.persistence_delegate.delete_integration_status(
             integration_level)
...
#+BEGIN_SRC python
    def test_get_integration_status(self):
         ...
         intstatus.save()
         intstatus_obj = self.persistence_delegate.
         get_integration_status(integration_level=
