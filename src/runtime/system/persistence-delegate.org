...
#+BEGIN_SRC python
    def test_lab_exists(self):
        ...
        integration_level = 4
        integration_status = Integration_Status(integration_level=integration_level)
        ...
        hosted_on = "cloud"
        host = Hosting_Info(hosting_status=hosting_status,
...
#+BEGIN_SRC python
    def test_hosting_info_exists(self):
        ...
        hosted_on1 = "cloud"
        hosting_info1 = Hosting_Info(hosting_status=hosting_status1, hosted_url=hosted_url1, hosted_on=hosted_on1)
        ...
        hosted_on2 = "server"
        hosting_info2 = Hosting_Info(hosting_status=hosting_status2, hosted_url=hosted_url2, hosted_on=hosted_on2)
...
#+BEGIN_SRC python
    def test_integration_status_exists(self):
        ...
        integration_status1 = Integration_Status(integration_level=integration_level1)
        intstatus1 = self.persistence_delegate.add_integration_status(integration_status1)

        integration_level2 = 2
        integration_status2 = Integration_Status(integration_level=integration_level2)
...
#+BEGIN_SRC python
    def test_add_lab(self):
         ...
         hosted_url = "http://cse14-iiith.vlabs.ac.in"
         hosted_on = "cloud"
         host = Hosting_Info(hosting_status=hosting_status, hosted_url=hosted_url, hosted_on=hosted_on)
         host.save()
...
#+BEGIN_SRC python
    def test_add_hosting_info(self):
         ...
         hosting_info = Hosting_Info.get_by_id(1)
...
#+BEGIN_SRC python
    def test_add_integration_status(self):
         ...
         integration_status = Integration_Status.get_by_id(1)
...
#+BEGIN_SRC python
    def test_update_hosting_info(self):
         ...
         hosted_url = "http://cse14-iiith.vlabs.ac.in"
         hosted_on = "cloud"
         hosting_info = Hosting_Info(hosting_status=hosting_status, hosted_url=hosted_url, hosted_on=hosted_on)
...
#+BEGIN_SRC python
    def delete_hosting_info(self, hosted_url):
        ...
        if not record:
            abort(404, 'No Hosting_Info with id %s' % (hosted_url))
        else:
            try:
                record.delete()
                #db.session.delete(record)
...
#+BEGIN_SRC python
    def test_delete_hosting_info(self):
         ...
         self.assertEqual(len(Hosting_Info.get_all()), 1)
...
#+BEGIN_SRC python
    def delete_integration_status(self, integration_level):
        ...
        if not record:
            abort(404, 'No Integration_Status with id %s' % (integration_level))
        else:
            try:
                record.delete()
                #db.session.delete(record)
...
#+BEGIN_SRC python
    def test_delete_integration_status(self):
         ...
         self.assertEqual(len(Integration_Status.get_all()), 1)
...
#+BEGIN_SRC python
    ...
    def test_get_lab_with_given_lab_id_and_lab_name(self):
         ...
         hosted_url = "http://cse14-iiith.vlabs.ac.in"
         hosted_on = "cloud"
         host = Hosting_Info(hosting_status=hosting_status, hosted_url=hosted_url, 
                hosted_on=hosted_on)
         host.save()
...
#+BEGIN_SRC python
    def get_hosting_info(self, **kwargs):
        return self.get_object(Hosting_Info, **kwargs)
...
#+BEGIN_SRC python
    def get_integration_status(self, **kwargs):
        return self.get_object(Integration_Status, **kwargs)
...
#+BEGIN_SRC python
    def test_get_integration_status(self):
         ...
         integration_level = 4
         intstatus = Integration_Status(integration_level=integration_level)                             
         intstatus.save()
