...
#+BEGIN_SRC python
    def update_lab(self, lab, lab_name, overview, institute, discipline,
                         integration_status, hosting_info):
...
#+BEGIN_SRC python
    def test_update_lab(self):
         ...
         hosted_on1 = "cloud"
         host1 = HostingInfo(hosting_status=hosting_status1, hosted_url=hosted_url1, hosted_on=hosted_on1)
         host1.save()

         lab2 = self.persistence_delegate.update_lab\
           (lab1, lab_name1, overview1, inst1, discipline1, integration_status1, [host1]),
