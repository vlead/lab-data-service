...
#+BEGIN_SRC python
    def test_hostinginfo_exists(self):
        ...
        hostinginfo1 = HostingInfo(hosting_status=hosting_status1, hosted_url=hosted_url1)
        host1 = self.persistence_delegate.add_hostinginfo(hostinginfo1)

        hosting_status2 = "not hosted"
        hosted_url2 = "http://iitkgp.vlab.co.in/"
        hostinginfo2 = HostingInfo(hosting_status=hosting_status2, hosted_url=hosted_url2)
...
#+BEGIN_SRC python
    def test_add_name(self):
         ...
         self.assertEqual(name.get("name"), name)
...
#+NAME: test_persistence_add_dev
#+BEGIN_SRC python
    def test_add_dev(self):
         print "test_add_dev"
         dev_name="Prof. S. Dharmaraja"
         email_id="dharmar@maths.iitd.ac.in"
         dev = Dev(dev_name=dev_name, email_id=email_id)
         dev = self.persistence_delegate.add_dev(dev)
        
         self.assertEqual(self.persistence_delegate.dev_exists(email.id),
                          True)
         self.assertEqual(self.persistence_delegate.dev_exists(email.id),
                          False)
...
#+BEGIN_SRC python
    def update_dev(self, dev, dev_name, email_id):
        dev.set(dev_name=dev_name, email_id=email_id)
        dev.save()
        return dev
...
#+BEGIN_SRC python
    def update_hostinginfo(self, hostinginfo, hosting_status):
        hostinginfo.set(hosting_status=hosting_status)
        hostinginfo.save()
        return hostinginfo
...
#+BEGIN_SRC python
    def test_update_hostinginfo(self):
         ...
         hostinginfo = HostingInfo(hosting_status=hosting_status, hosted_url=hosted_url)
