...
class TestAddLab(TestCase):
    ...
    def test_add_lab(self):
        ...
        phase = phase_cls(phase_id=1)
        phase.save()

        institute_name = "IIT Kanpur"
        institute_id = "IITK"
        inst = institute_cls(institute_name=institute_name,
        ...
        discipline_id = "IITK"
        discipline = discipline_cls(discipline_name=\
                                    discipline_name,
                                    discipline_id=\
                                    discipline_id,
                                    assets=[asset])
        ...
        hosted_on = "cloud"
        host = hosting_info_cls(hosting_status=\
                                hosting_status,
        ...
        exp_id = "cse02"
        overview = "overview"
        experiment = experiment_cls(exp_name=exp_name,
                                    exp_id=exp_id,
                                    overview=overview,
                                    sections=[],
                                    institute=inst,
...
#+NAME: test_add_phase
#+BEGIN_SRC python
class TestAddphase_cls(TestCase):
    TESTING = True
    ...
    def test_add_phase_in_system_persistence(self):
        
        print "test_add_phase_in_system_persistence"
        session_cls = System.delegate.entities['session']
        phase_cls = System.delegate.entities['phase']

        phase = phase_cls(phase_id=1)
        session = session_cls(key=KEY)
        phase = System.do("add_phase", phase=phase, session=session)
        new_phase = phase_cls.get_by_id(1)
        self.assertEqual(new_phase.get("phase_id"), 1)
...
class TestUpdateLab(TestCase):
    ...
    def test_update_lab(self):
        ...
        integration_level = 4
        integration_status = integration_status_cls\
        ...
        asset1 = asset_cls(asset_type=asset_type1,
                               path=path1)
        asset1.save()

        institute_name1 = "IIT Kharagpur"
        institute_id1 = "IITKgp"
        inst1 = institute_cls(institute_name=
                                institute_name1,
                                institute_id=institute_id1,
                                assets=[asset])
        inst1.save()

        phase1 = phase_cls(phase_id=2)
        phase1.save()

        discipline_name1 = "Computer Science & Engineering"
        discipline_id1 = "CSE02"
        discipline1 = discipline_cls(discipline_name=\
                                    discipline_name1,
                                    discipline_id=\
                                    discipline_id1,
                                    assets=[asset])
        ...
        integration_status1 = integration_status_cls\
          (integration_level=integration_level1)
        ...
        hosted_on1 = "cloud"
        host1 = hosting_info_cls(hosting_status=\
                                hosting_status1,
        ...
        exp_id1 = "cse03"
        experiment1 = experiment_cls(exp_name=exp_name1,
                                    exp_id=exp_id1,
                                    overview=overview1,
                                    sections=[],
                                    institute=inst1,
        ...
        lab1 = System.do("update_lab", lab=lab,
                             lab_name=lab_name1,
                             overview=overview1,
                             institute=inst1,
                             discipline=discipline1,
        ...
        self.assertEqual(new_lab.get("institute").\
                             get("institute_id"),
                             institute_id1)
        self.assertEqual(new_lab.get("discipline").\
                             get("discipline_id"),
                             discipline_id1)
        self.assertEqual(new_lab.get("integration_status").
                             get("integration_level"),
                             integration_level1)
        self.assertEqual(new_lab.get("hosting_info")[0].\
                             get("hosted_url"), 
                              hosted_url1)
        self.assertEqual(new_lab.get("developers")[0].\
                             get("email").get("email"), 
                              email_id1.get("email"))
        self.assertEqual(new_lab.get("assets")[0].\
                             get("path"), 
                              path1)
        self.assertEqual(new_lab.get("experiments")[0].\
                             get("exp_id"), 
...
* Test Deletephase_cls 
#+NAME:  test_delete_phase 
#+BEGIN_SRC python
class TestDeletephase_cls(TestCase):
    ...
    def test_delete_phase(self):
        print "test_delete_phase_in_system_persistence"
        session_cls = System.delegate.entities['session']
        phase_cls = System.delegate.entities['phase']

        key = KEY
        session = session_cls(key=key)
        phase1 = phase_cls(phase_id=1)
        phase1.save()

        phase2 = phase_cls(phase_id=2)
        phase2.save()

        phase = System.do("delete_phase", phase_id=1,
                              session=session)

        self.assertEqual(len(phase_cls.get_all()), 1)
...
class TestGetLabByDiscipline(TestCase):
    ...
    def test_get_labs_by_discipline(self):
        ...
        lab = lab_cls(lab_id=lab_id1, lab_name=lab_name1,
                          ...
                          hosting_info=[host], assets=[asset], phase=[phase],
...
class TestGetLabByLabName(TestCase):
    ...
    def test_get_labs_by_lab_name(self):
        ...
        section.save()
        lab = lab_cls(lab_id=lab_id1, lab_name=lab_name1, 
                          integration_status=integration_status, phase=[phase],
                          institute=inst, discipline=discipline, sections=[section],
...
class TestGetLabByAsset(TestCase):
    ...
    def test_get_labs_by_asset(self):
        ...
        lab = lab_cls(lab_id=lab_id1, lab_name=lab_name1, phase=[phase],
                          integration_status=integration_status,
                          institute=inst, discipline=discipline, 
                          hosting_info=[host], assets=[asset],
                          overview=overview, experiments=[], developers=[dev])
...
class TestGetName(TestCase):
    ...
    def test_get_name(self):
        ...
        name2 = System.do("get_name", name=name)
...
#+NAME: test_get_phase
#+BEGIN_SRC python
class TestGetphase_cls(TestCase):
    TESTING = True
    ...
    def test_get_phase(self):
        ...
        print "test_get_phase_in_system_persistence"
        session_cls = System.delegate.entities['session']
        phase_cls = System.delegate.entities['phase']
        ...
        self.assertEqual(phase.get("phase_id"), 1)
...
class TestGetEmail(TestCase):
    ...
    def test_get_email(self):
        ...
        email2 = System.do("get_email", email=email)
...
class TestGetName(TestCase):
    ...
    def test_get_section(self):
        ...
        name2 = System.do("get_section", name=name)
