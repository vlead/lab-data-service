...
class TestAddLab(TestCase):
    ...
    def test_add_lab(self):
        ...
        hosted_on = "cloud"
        host = hostinginfo_cls(hosting_status=hosting_status, hosted_url=hosted_url, hosted_on=hosted_on)
        host.save()
        ...
        lab = lab_cls(lab_id=lab_id1, lab_name=lab_name1,        
                          ...
                          overview=overview,  integrationstatus=integrationstatus, 
                          experiments=[experiment], developers=[dev], hostinginfo=host)
...
class TestUpdateExperiment(TestCase):
    ...
    def test_update_exp(self):
        ...
        exp1 = System.do("update_experiment", exp_name=exp_name2,
                             experiment=experiment, overview=overview2, session=session)
...
class TestGetLab(TestCase):
    ...
    def test_get_lab(self):
        ...
        hosted_url = "http://cse14-iiith.vlabs.ac.in"
        hosted_on = "cloud"
        host = hostinginfo_cls(hosting_status=hosting_status,
        ...
        lab = lab_cls(lab_id=lab_id1, lab_name=lab_name1,
                          ...
                          hostinginfo=host, integrationstatus=integrationstatus)
...
class TestGetLabByInstitute(TestCase):
    ...
    def test_get_labs_by_institute(self):
        ...
        lab = lab_cls(lab_id=lab_id1, lab_name=lab_name1,
                          institute=inst, discipline=discipline, assets=[asset],
                          overview=overview, experiments=[], integrationstatus=integrationstatus, 
                          hostinginfo=host, developers=[dev])
...
* Test GetIntegrationStatusByIL
#+NAME:  test_get_integrationstatus_by_IL 
#+BEGIN_SRC python
class TestGetIntegrationStatusByIL(TestCase):
    ...
    def test_get_integrationstatus_by_IL(self):
        print "test_get_integrationstatus_by_IL_in_system_persistence"
        session_cls = System.delegate.entities['session']
        integrationstatus_cls = System.delegate.entities['integrationstatus']
        integration_level = 4
        integrationstatus = integrationstatus_cls(integration_level=integration_level)
        ...
        integrationstatus = System.do("get_integrationstatus_by_IL", 
...
<<test_get_integrationstatus_by_IL>>
<<run_test_cases>>
