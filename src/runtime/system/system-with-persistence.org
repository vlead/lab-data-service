...
class TestAddHostingInfo(TestCase):
    ...
    def test_add_hostinginfo(self):
        ...
        hostinginfo = hostinginfo_cls(hosting_status=hosting_status, hosted_url=hosted_url)
...
class TestUpdateHostingInfo(TestCase):
    ...
    def test_update_hostinginfo(self):
        ...
        key = KEY
        session = session_cls(key=key)
        hostinginfo = hostinginfo_cls(hosting_status=hosting_status1, hosted_url=hosted_url1)

        hostinginfo.save()

        hosting_status2="not hosted"

        hostinginfo1 = System.do("update_hostinginfo", hosting_status=hosting_status2,
