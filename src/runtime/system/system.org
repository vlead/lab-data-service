...
class UpdateInstitute():
    arg_types = {"inst_id": is_str, "inst_name": is_str_or_none, 
                       "session": is_session}                               
    arity_and_type_checks_needed = True
    ...
    def action(args):
        ...
        if not "inst_name" in args:
           inst_name=question.get("inst_name")
        else:
           inst_name=args["inst_name"]
       
        institute = System.delegate.update_institute(institute, inst_name, inst_id)
        return institute
