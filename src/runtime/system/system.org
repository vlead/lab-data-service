...
class UpdateLab():
    arg_types = {"lab": is_lab, "lab_name": is_str,
                     ...
                     "institute" : is_institute, "discipline" : is_discipline,
...
class UpdateDiscipline():
    ...
    def action(args):
        ...
        assets = args["assets"]
        dis = System.delegate.update_discipline(discipline, dis_name, assets)
        return dis
...
class UpdateInstitute():
    ...
    def action(args):
        ...
        institute = args["institute"]       
        assets = args["assets"]
        institute = System.delegate.update_institute(institute, inst_name, assets)
        return institute
...
class UpdateDeveloper():
    arg_types = {"developer": is_developer, "name": is_name,
                 "session": is_session, "institute": is_institute,
                 "discipline" : is_discipline}
    arity_and_type_checks_needed = True
    ...
    def action(args):
        ...
        institute = args["institute"]
        discipline = args["discipline"]
        developer = System.delegate.update_developer(developer, name, institute, discipline)
        return developer
...
from runtime.objects.entities import is_str, is_lab, are_labs,\
     ...
     are_hosting_info, are_developers
