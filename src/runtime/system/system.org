...
class AddDeveloper():
    arg_types = {"developer": is_developer, "name": is_name,
                     "email": is_email, "session": is_session}
    arity_and_type_checks_needed = True
...
class UpdateHostingInfo():
    arg_types = {"hostinginfo": is_hostinginfo, "hosting_status": is_str_or_none, 
                       "session": is_session}                               
    arity_and_type_checks_needed = True
    ...
    def action(args):
        ...
        hostinginfo = args["hostinginfo"]       
        hostinginfo = System.delegate.update_hostinginfo(hostinginfo, hosting_status)
        return hostinginfo
