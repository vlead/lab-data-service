...
** =GetIntegrationStatusByIL=
#+NAME: class_get_integrationstatus_by_IL
#+begin_src python
class GetIntegrationStatusby_IL():
    ...
    def action(args):
        integration_level = args["integration_level"]
        integration_level = System.delegate.get_integrationstatus\
...
ops_table = {'add_lab' : AddLab,
             ...
             'get_integrationstatus_by_IL': GetIntegrationStatusby_IL,
