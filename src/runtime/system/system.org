...
#+begin_src python
class UpdateLab():
    arg_types = {"lab_id": is_str, "lab_name": is_str_or_none,
    ...
    def action(args):
        ...
        lab = System.delegate.update_lab(lab, lab_name, lab_id, overview)
        return lab
...
class UpdateDiscipline():
    arg_types = {"dis_id": is_str, "dis_name": is_str_or_none,
                     "overview" : is_str, "session": is_session}
    arity_and_type_checks_needed = True
    ...
    def action(args):
        dis_id = args["dis_id"]
        dis = System.delegate.get_disicipline(dis_id=dis_id)

        if not "dis_name" in args:
           dis_name=question.get("dis_name")
        else:
           dis_name=args["dis_name"]

        if not "overview" in args:
           overview = dis.get("overview")
        else:
           overview = args["overview"]

        dis = System.delegate.update_dis(dis, dis_name, dis_id, overview)
        return dis
...
class DeleteDiscipline():
    ...
    def action(args):
        dis_id = args["dis_id"]
        dis_id = System.delegate.delete_dis(dis_id)
        return dis_id
...
class UpdateInstitute():
    ...
    def action(args):
        institute = args["institute"]
        if not "inst_name" in args:
           inst_name=institute.get("inst_name")
        else:
           inst_name=args["inst_name"]

        if not "inst_id" in args:
           inst_id = institute.get("inst_id")
        else:
           inst_id = args["inst_id"]
               
        inst = System.delegate.update_institute(institute, inst_name,\
            inst_id)
        return inst
...
class DeleteInstitute():
    arg_types = {"i_id": is_int, "session": is_session}
    arity_and_type_checks_needed = True
    ...
    def action(args):
        i_id = args["i_id"]
        i_id = System.delegate.delete_institute(i_id)
        return i_id
...
#+begin_src python
class AddDeveloper():
    arg_types = {"developer": is_developer, "name": is_name, "email": is_email, "session": is_session}
    arity_and_type_checks_needed = True
...
class DeleteName():
    ...
    def action(args):
        ...
        name_id = System.delegate.delete_name(name_id)
        return name_id
...
class DeleteEmail():
    ...
    def action(args):
        ...
        email_id = System.delegate.delete_email(email_id)
        return email_id
...
class DeleteDeveloper():
    arg_types = {"developer_id": is_developer, "name": is_name, "email": is_email}
    arity_and_type_checks_needed = True
    ...
    def action(args):
        ...
        developer_id = System.delegate.delete_developer(developer_id)
        return developer_id
...
#             'add_labs_to_institute' : AddLabsToInstitute,
