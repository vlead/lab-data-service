...
#+begin_src python
    ...
    def add_lab(data_dict):
        ...
        inst_id = data_dict['lab']['institute_id']
        ...
        dis_id = data_dict['lab']['discipline_id']
        ...
        for asset_x in assets:
            ...
            if asset is None:
                asset = asset_cls(asset_type=str(asset_x['asset_type']), \
...
#+begin_src python
    ...
    def add_experiment(data_dict):
        ...
        inst_id = data_dict['experiment']['institute_id']
        institute = System.do("get_institute", inst_id=inst_id)

        dis_id = data_dict['experiment']['discipline_id']
        discipline = System.do("get_discipline", dis_id=dis_id)
...
#+begin_src python
    ...
    def add_institute(data_dict):
        ...
        for asset in assets:
            ...
            asset_list.append(asset)
        institute = institute_cls(inst_name=str(data_dict['institute_name']),
                                  inst_id=str(data_dict['institute_id']),
                                  assets=asset_list)
...
class TestAddInstitute(TestCase):
    ...
    def test_add_institute_in_system_interface(self):
        ...
        self.assertEqual(institute.get("inst_id"), data_dict['institute_id'])
...
#+begin_src python
    ...
    def add_discipline(data_dict):
        ...
        discipline = discipline_cls(dis_name=data_dict['discipline_name'],
                                    dis_id=data_dict['discipline_id'],
                                    assets=asset_list)
        try:
...
class TestAddDiscipline(TestCase):
    ...
    def test_add_discipline_in_system_interface(self):
        ...
        self.assertEqual(discipline.get("dis_id"), data_dict['discipline_id'])
...
class TestGetInstitutes(TestCase):
    ...
    def test_get_institutes_in_system_interface(self):
        ...
        self.assertEqual(inst_list[0].get("inst_name"), data_dict['institute_name'])
        self.assertEqual(inst_list[1].get("inst_name"), data_dict1['institute_name'])
...
class TestGetDisciplines(TestCase):
    ...
    def test_get_disciplines_in_system_interface(self):
        ...
        self.assertEqual(dis_list[0].get("dis_name"), data_dict["discipline_name"])
        self.assertEqual(dis_list[1].get("dis_name"), data_dict1["discipline_name"])
...
class TestGetInstituteById(TestCase):
    ...
    def test_get_institute_by_id_in_system_interface(self):
        ...
        self.assertEqual(inst_data_one.get("inst_name"), data_dict['institute_name'])
        self.assertEqual(inst_data_two.get("inst_name"), data_dict1['institute_name'])
...
class TestGetDisciplineById(TestCase):
    ...
    def test_get_discipline_by_id_in_system_interface(self):
        ...
        self.assertEqual(dis_data_one.get("dis_name"), data_dict["discipline_name"])
        self.assertEqual(dis_data_two.get("dis_name"), data_dict1["discipline_name"])
...
#+begin_src python
    ...
    def update_lab(data_dict):
        ...
        if 'institute_id' not in data_dict['lab']:
            ...
            inst = System.do("get_institute", inst_id=
                                      data_dict['lab']['institute_id'])

        if 'discipline_id' not in data_dict['lab']:
            dis=str(lab.get("discipline"))
        else:
            dis = System.do("get_discipline", dis_id=
                                       data_dict['lab']['discipline_id'])
        ...
        experiments = data_dict['lab']['sections'][1]['experiments']
...
class TestUpdateLab(TestCase):
    ...
    def test_update_lab_in_system_interface(self):
        ...
        self.assertEqual(lab1.get("institute").get("inst_id"),
                             data_dict1['lab']['institute_id'])
        self.assertEqual(lab1.get("discipline").get("dis_id"),
...
#+begin_src python
    ...
    def update_experiment(data_dict):
        ...
        if 'discipline_id' not in data_dict['experiment']:
            ...
            disc= System.do("get_discipline", dis_id=
                                data_dict['experiment']['discipline_id'])
...
class TestUpdateExperiment(TestCase):
    ...
    def test_update_experiment_name_in_system_interface(self):
        ...
        data_dict1 = {"key" : KEY,
                      "experiment": {
                         ...
                         "assets": [
                            ...
                            {
                               "asset_type": "Video",
                               "path": "vlabs.ac.in/images/video/image.png"
                            }
                         ],
                         "developers": [
                            {
        ...
        self.assertEqual(exp1.get("institute").get("inst_id"),
                             data_dict1['experiment']['institute_id'])
        self.assertEqual(exp1.get("discipline").get("dis_id"),
...
#+begin_src python       
    ...
    def update_institute(data_dict):
        ...
        institute = System.do("get_institute", inst_id=str(data_dict['institute_id']))

        assets = data_dict['assets']
        asset_list = []
        for asset_x in assets:
            asset = System.do("get_asset", path=asset_x)
            if asset is None:
                asset = asset_cls(asset_type=str(asset_x['asset_type']), \
                                      path=str(asset_x['path']))
                asset = System.do("add_asset", asset=asset, session=session)
        ...
        if 'institute_name' not in data_dict:
            ...
            inst_name=data_dict['institute_name']
...
class TestUpdateInstitute(TestCase):
    ...
    def test_update_institute_name_in_system_interface(self):
        ...
        self.assertEqual(institute1.get("inst_name"), data_dict1['institute_name'])
...
#+begin_src python       
    ...
    def update_discipline(data_dict):
        ...
        dis_id = str(data_dict['discipline_id'])
        discipline = System.do("get_discipline", dis_id=dis_id)
        ...
        if "discipline_name" not in data_dict:
            dis_name=str(discipline.get("discipline_name"))
        else:
            dis_name=data_dict["discipline_name"]
...
class TestUpdateDiscipline(TestCase):
    ...
    def test_update_discipline_name_in_system_interface(self):
        ...
        self.assertEqual(dis.get("dis_name"), data_dict1['discipline_name'])
...
class TestDeleteDiscipline(TestCase):
    ...
    def test_delete_discipline_name_in_system_interface(self):
        ...
        dis = SystemInterface.add_discipline(data_dict)
        dis1 = SystemInterface.add_discipline(data_dict1)
        dis_id = SystemInterface.delete_discipline('ECE', KEY)

        self.assertEqual(dis_id,'ECE')
...
class TestGetInstituteByInstituteId(TestCase):
    ...
    def test_get_institute_by_instituteid_in_system_interface(self):
        ...
        self.assertEqual(institute.get("inst_id"), data_dict['institute_id'])
        self.assertEqual(institute1.get("inst_id"), data_dict1['institute_id'])
...
class TestGetDisciplineByDisciplineId(TestCase):
    ...
    def test_get_discipline_by_disid_in_system_interface(self):
        ...
        self.assertEqual(dis.get("dis_id"), data_dict['discipline_id'])
        self.assertEqual(dis1.get("dis_id"), data_dict1['discipline_id'])
...
class TestGetAssets(TestCase):
    ...
    def test_get_assets_in_system_interface(self):
        ...
        self.assertEqual(asset_dict_list[0].get("asset_type"), data_dict['asset_type'])
        self.assertEqual(asset_dict_list[1].get("asset_type"), data_dict1['asset_type'])
