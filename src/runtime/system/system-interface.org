...
#+begin_src python
    ...
    def add_lab(data_dict):
        ...
        for developer_x in developers:
            ...
            institute = System.do("get_institute", inst_id=developer_x['inst_id'])
            discipline = System.do("get_discipline", dis_id=developer_x['dis_id'])
            if developer is None:
                developer = developer_cls(name=name, email=email, institute=institute, discipline=discipline)
...
class TestAddExperiment(TestCase):
    ...
    def test_add_experiment_in_system_interface(self):
        ...
        self.assertEqual(experiment.get("sections")[0].get("name"), 'Theory')
...
class TestUpdateLab(TestCase):
    ...
    def test_update_lab_in_system_interface(self):
        ...
        data_dict1 = {
                    'key' : KEY,
                    'dis_name': 'electronics engineering',
                    'dis_id': 'ECE',
                    'assets': ['vlabs.ac.in/images/video/icon.png']
                    }
        ...
        data_dict1 = {
                    ...
                    'hosting_info': [{'hosted_url':'http://cse13-iiith.vlabs.ac.in',
                                    ...
                                    'hosting_status': 'hosted',
                                    'hosted_on': 'server'}],
                   'assets': [{'path':'vlabs.ac.in/images/static/icon.png',
                                    'asset_type': 'image'}],
                    'developers': [{'name':'Prof. Dharamaja',
                                    'email': 'xyz@gmail.com',
                                    'inst_id': 'IITK', 'dis_id': 'CSE'},
...
#+begin_src python
    ...
    def update_experiment(data_dict):
        ...
        if 'inst_id' not in data_dict:
            ...
            inst= System.do("get_institute", inst_id=data_dict['inst_id'])

        if 'dis_id' not in data_dict:
            disc=str(experiment.get("discipline"))
        else:
            disc= System.do("get_discipline", dis_id=data_dict['dis_id'])
...
class TestUpdateExperiment(TestCase):
    ...
    def test_update_experiment_name_in_system_interface(self):
        ...
        self.assertEqual(exp1.get("overview"), data_dict1['overview'])
...
#+begin_src python       
    ...
    def update_institute(data_dict):
        ...
        institute = System.do("get_institute", inst_id=str(data_dict['inst_id']))
...
#+begin_src python
    ...
    def update_developer(data_dict):
        ...
        if 'name' not in data_dict:
            ...
            name=name_cls(name=data_dict['name'])

        if 'inst_id' not in data_dict:
            inst=developer.get("institute")
        else:
            inst = System.do("get_institute", inst_id=data_dict['inst_id'])

        if 'dis_id' not in data_dict:
            disc=developer.get("discipline")
        else:
            disc = System.do("get_discipline", dis_id=data_dict['dis_id'])
        ...
        try:
            ...
            developer = System.do("update_developer", name=name,
                                      developer=developer, institute=inst,
                                      discipline=disc, session=session)
...
class TestUpdateDeveloper(TestCase):
    ...
    def test_update_developer_name_in_system_interface(self):
        ...
        self.assertEqual(developer1.get("name").get("name"),
                             data_dict1['name'])
        self.assertEqual(developer1.get("institute").get("inst_id"), data_dict1['inst_id'])
        self.assertEqual(developer1.get("discipline").get("dis_id"), data_dict1['dis_id'])
...
class TestDeleteDiscipline(TestCase):
    ...
    def test_delete_discipline_name_in_system_interface(self):
        ...
        data_dict1 = {'dis_name': 'Electronics and Communication',
                    'dis_id': 'ECE',
                    'key' : KEY,
                    'assets': ['vlabs.ac.in/images/static/logo.png']
                    }
