...
* The =SystemInterface= class
  :PROPERTIES:
  :CUSTOM_ID:the_system_interface_class 
  :END: 

** Constructor
  :PROPERTIES:
  :CUSTOM_ID: class_system_interface
  :END: 
...
** Get Experiments
  :PROPERTIES:
  :CUSTOM_ID: class_get_experiments
  :END: 
...
*** TestGetExperiments
  :PROPERTIES:
  :CUSTOM_ID: test_class_get_sections
  :END: 
...
** Get Experiment By Id
  :PROPERTIES:
  :CUSTOM_ID: class_get_experiment_by_id
  :END: 
