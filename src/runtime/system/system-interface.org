...
#+begin_src python
    ...
    def add_name(data_dict):
        ...
        session = session_cls(key=data_dict['key'])
        name = section_cls(name=data_dict['name'])
        try:
            current_app.logger.debug("running operation add_section")
...
#+begin_src python
    ...
    def add_email(data_dict):
        ...
        session = session_cls(key=data_dict['key'])
        email = email_cls(name=data_dict['email'])
        try:
...
#+begin_src python
    ...
    def add_developer(data_dict):
        ...
        session = session_cls(key=data_dict['key'])
        developer = developer_cls(dev_name=data_dict['dev_name'],
                                dev_email=data_dict['dev_email'])
        try:
            current_app.logger.debug("running operation add_developer")
            question = System.do("add_developer", developer=developer, 
                                    session=session)
...
class TestAddDeveloper(TestCase):
    ...
    def test_add_developer_in_system_interface(self):
        ...
        self.assertEqual(developer.get("dev_name"), 
                             data_dict['dev_name'])
        self.assertEqual(developer.get("dev_email"), data_dict['dev_email'])
