...
#+begin_src python
    ...
    def update_experiment(data_dict):
        ...
        if 'inst_id' not in data_dict:
            institute=str(experiment.get("institute"))
        else:
            institute= System.do("get_institute", inst_id=data_dict['inst_id'])

        if 'dis_id' not in data_dict:
            discipline=str(experiment.get("discipline"))
        else:
            discipline= System.do("get_discipline", dis_id=data_dict['dis_id'])
        ...
        try:
            ...
            exp = System.do("update_experiment", exp_name=exp_name, 
                                    ...
                                    session=session, institute=institute, 
                                    discipline=discipline, 
                                    integration_status=integration_status)
