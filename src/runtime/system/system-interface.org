...
#+begin_src python
    ...
    def update_lab(data_dict):
        ...
        if 'integration_status' not in data_dict:
...
class TestUpdateLab(TestCase):
    ...
    def test_update_lab_in_system_interface(self):
        ...
        self.assertEqual(lab1.get("inst_id"), data_dict1['inst_id'])
        self.assertEqual(lab1.get("dis_id"), data_dict1['dis_id'])
        self.assertEqual(lab1.get("integration_level"), data_dict1['integration_level'])
