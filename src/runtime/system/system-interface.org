...
#+begin_src python
    ...
    def add_experiment(data_dict):
        ...
        for developer_x in developers:
            developer = System.do("get_developer", email=developer_x['email'])
            if developer is None:
                developer = developer_cls(name=str(developer_x['name']), \
                                      email=str(developer_x['email']))
