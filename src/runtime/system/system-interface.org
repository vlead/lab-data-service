...
#+begin_src python
    ...
    def add_lab(data_dict):
        ...
        hostinginfos = data_dict['hostinginfos']
        hostinginfo_list = []
        for hostinginfo in hostinginfos:
            hostinginfo = System.do("get_hostinginfo", hosted_url=hostinginfo)
            hostinginfo_list.append(hostinginfo)
...
class TestAddLab(TestCase):
    ...
    def test_add_lab_in_system_interface(self):
        ...
        self.assertEqual(lab.get("hostinginfos")[0].get("hosted_url"),
...
class TestAddExperiment(TestCase):
    ...
    def test_add_experiment_in_system_interface(self):
        ...
        self.assertEqual(experiment.get("assets")[0].get("path"), 
                             'vlabs.ac.in/images/static/logo.png')
        self.assertEqual(experiment.get("hostinginfos")[0].get("hosted_url"),
                             'http://cse14-iiith.vlabs.ac.in')
