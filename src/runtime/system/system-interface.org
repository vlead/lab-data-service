...
#+begin_src python
    ...
    def update_lab(data_dict):
        ...
        lab = System.do("get_lab", lab_id=lab_id, session=session)
...
#+begin_src python
    ...
    def update_experiment(data_dict):
        ...
        experiment = System.do("get_experiment", exp_id=exp_id, session=session)
...
#+begin_src python       
    ...
    def update_institute(data_dict):
        ...
        inst_id = str(data_dict['inst_id'])
        institute = System.do("get_institute", inst_id=inst_id, session=session)
