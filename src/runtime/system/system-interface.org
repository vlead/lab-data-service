...
#+begin_src python
    @staticmethod
    def delete_developer(data_dict):
        session_cls = System.delegate.entities['session']
        email_cls = System.delegate.entities['email']
        ...
        try:
            ...
            developer = System.do("delete_developer", email=str(email),
                                    session=session)
...
class TestDeleteDeveloper(TestCase):
    ...
    def test_delete_developer_in_system_interface(self):
        ...
        dev_id = SystemInterface.delete_developer(data_dict['email'])
        
        self.assertEqual(dev_id, data_dict['email'])
