...
#+begin_src python
    ...
    def update_lab(data_dict):
        ...
        if 'inst_id' not in data_dict:
            institute=str(lab.get("institute"))
        else:
            institute = System.do("get_institute", inst_id=
                                      data_dict['inst_id'])

        if 'dis_id' not in data_dict:
            discipline=str(lab.get("discipline"))
        else:
            discipline = System.do("get_discipline", dis_id=
                                       data_dict['dis_id'])
...
class TestUpdateDeveloper(TestCase):
    ...
    def test_update_developer_name_in_system_interface(self):
        ...
        self.assertEqual(developer1.get("name").get("name"),
                             data_dict1['name'])
        self.assertEqual(developer1.get("inst_id"), data_dict1['inst_id'])
        self.assertEqual(developer1.get("dis_id"), data_dict1['dis_id'])
