...
Sets
  ...
  experiment-set  : set[Experiment]  ; set of all experiments in the system
  institute-set  : set[Institute]  ; set of all institutes in the system
  discipline-set  : set[Discipline]  ; set of all disciplines in the system
  developer-set  : set[Developer]  ; set of all developers in the system
  name-set  : set[Name]  ; set of all names in the system
  email-set  : set[Email]  ; set of all emails in the system
...
#+BEGIN_SRC spec :tangle spec.txt
  ...
  lab_id-set      : lab-set.lab_id             ; set of lab ids in the system
  exp_id-set      : experiment-set.exp_id      ; set of exp ids in the system
  inst_id-set     : institute-set.inst_id      ; set of inst ids in the system
  disc_id-set     : discipline-set.disc_id     ; set of disc ids in the system
