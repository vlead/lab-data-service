...
*** HostingInformation
:PROPERTIES:
:CUSTOM_ID: entity_HostingInformation
:END: 
  Requirement satisfied: [[../requirements/index.org::#req6][HostingInformation]]
#+BEGIN_SRC spec :tangle spec.txt
;;; Entity Types
TYPE HostingInformation
#+END_SRC

*** Assets
:PROPERTIES:
:CUSTOM_ID: entity_Assets
:END: 
  Requirement satisfied: [[../requirements/index.org::#req7][Assets]]
#+BEGIN_SRC spec :tangle spec.txt
;;; Entity Types
TYPE Assets
#+END_SRC
...
[hostinginformation, lab] : HostingInformation ! > Lab +
[assets, lab]             : Assets + > lab !
...
#+BEGIN_SRC spec :tangle spec.txt
  ...
  hostinginformation-set : lab-set.hostinginformation ; set of hosting information in the system
  assets-set             : lab-set.assets             ; set of assets in the system
  ...
  hosting-status-set : hostinginformation-set.hosting_status ; set of all hosting_status in the system
  hosted-url-set : hostinginformation-set.hosted_url    ; set of all hosted_urls in the system
  assets-type-set : assets-set.assets_type     ; set of all assets_types in the system
  assets-path-set : assets-set.assets_path     ; set of all assets_paths in the system
...
[hostinginformation, labs]  :  lab-set + > hostinginformation-set !
[assets, labs]              :  lab-set ! > assets-set +
...
** Add HostingInformation
  :PROPERTIES:
  :CUSTOM_ID: add_hostinginformation
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: add_hostinginformation_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    h: HostingInformation, s: Session
#+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: add_hostinginformation_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
*** Referential Integrity
  :PROPERTIES:
  :CUSTOM_ID: add_hostinginformation_referential_integrity
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    h : ~hostinginformation-set
#+END_SRC
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: add_hostinginformation_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    h = new hostinginformation
    hostinginformation-set = hostinginformation-set U {h}
#+END_SRC
...
** Add Assets
:PROPERTIES:
  :CUSTOM_ID: add_assets
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: add_assets_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    a: Assets, s: Session
#+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: add_assets_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
*** Referential Integrity
  :PROPERTIES:
  :CUSTOM_ID: add_assets_referential_integrity
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    a: ~assets-set
#+END_SRC
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: add_assets_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    a = new assets    
   assets-set = assets-set U {a}
#+END_SRC
...
** Update HostingInformation
  :PROPERTIES:
  :CUSTOM_ID: update_hostinginformation
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: update_hostinginformation_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
   hs: hosting_status, hu: hosted_url, h: HostingInformation , s: Session
   #+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: update_hostinginformation_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
*** Referential Integrity
  :PROPERTIES:
  :CUSTOM_ID: update_hostinginformation_referential_integrity
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    h  : hostinginformation-set
    s  : session-set
...
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: update_hostinginformation_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    The HostingInformation details are updated.
#+END_SRC


** Update Assets
  :PROPERTIES:
  :CUSTOM_ID: update_assets
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: update_assets_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    at: assets_type, ap: assets_path, a: Assets, s: Session
#+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: update_assets_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
*** Referential Integrity
  :PROPERTIES:
  :CUSTOM_ID: update_assets_referential_integrity
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    a : assets-set
    s : session-set
...
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: update_assets_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    The Assets details are updated.
#+END_SRC


** Update IntegrationStatus
  :PROPERTIES:
  :CUSTOM_ID: update_integrationstatus
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: update_integrationstatus_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    i: IntegrationStatus, l:Level, s: Session
#+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: update_integrationstatus_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
...
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: update_integrationstatus_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    The Integration Status details are updated.
#+END_SRC
...
** Delete HostingInformation
  :PROPERTIES:
  :CUSTOM_ID: delete_hostinginformation
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: delete_hostinginformation_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    h: HostingInformation, s: Session
#+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: delete_hostinginformation_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
*** Referential Integrity
  :PROPERTIES:
  :CUSTOM_ID: delete_hostinginformation_referential_integrity
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    h : hostinginformation-set
    s : session-set
...
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: delete_hostinginformation_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    hostinginformation-set = hostinginformation-set - {h}
...
** Delete Assets
  :PROPERTIES:
  :CUSTOM_ID: delete_assets
  :END:
*** Parameters
  :PROPERTIES:
  :CUSTOM_ID: delete_assets_parameters
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    a: Assets, s: Session
#+END_SRC
*** Actor credentials
  :PROPERTIES:
  :CUSTOM_ID: delete_assets_actor_credentials
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    s.key == system configured key
#+END_SRC
*** Referential Integrity
  :PROPERTIES:
  :CUSTOM_ID: delete_assets_referential_integrity
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    a : assets-set
    s : session-set
...
*** Effect
  :PROPERTIES:
  :CUSTOM_ID: delete_assets_effect
  :END:
#+BEGIN_SRC spec :tangle spec.txt
    assets-set = assets-set - {a}
