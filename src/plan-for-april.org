...
|      | 6. Asset               |                         | 3 Days                         | 4 Days                       | Done                       | Sanchita,Mrudhvika          |
|      | 7. Hosting Information |                         | 3 Days                         | 3 Days                       | Done                       | Reena                       |
|      | 8. Integration Status  |                         | 3 Days                         | 3 Days                       | Done                       | Reena                       |
|------+------------------------+-------------------------+--------------------------------+------------------------------+----------------------------+-----------------------------|
...
|------+------------------------+-------------------------+--------------------------------+------------------------------+----------------------------+-----------------------------|
  ...
  * *includes end to end implementation across all layers, CRUD operations
    (Objects,persistence,system,REST), unit test cases, integration of Lab with
    other entities.*
