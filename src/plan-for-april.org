...
|------+------------------------+---------------+-----------------+----------------+-----------------------+--------------------------+---+---|
|    3 | Implementation         | [[https://github.com/vlead/lab-data-service/issues/5][#5]] , [[https://github.com/vlead/lab-data-service/issues/6][#6]] , [[https://github.com/vlead/lab-data-service/issues/7][#7]]  | 1.5 Months      | 2 Months       |                       |                          |   |   |
|      |                        | [[https://github.com/vlead/lab-data-service/issues/9][#9]] , [[https://github.com/vlead/lab-data-service/issues/10][#10]]      |                 |                |                       |                          |   |   |
...
|------+------------------------+---------------+-----------------+----------------+-----------------------+--------------------------+---+---|
|    4 | Data Model Review      | [[https://github.com/vlead/lab-data-service/issues/12][#12]]           | 1 Day           | 1 Day          | Done                  | Thirumal, Sripathi,      |   |   |
|      |                        |               |                 |                | (By Sripathi,Madhavi) | Madhavi                  |   |   |
|------+------------------------+---------------+-----------------+----------------+-----------------------+--------------------------+---+---|
|    5 | Implementation Review  | [[https://github.com/vlead/lab-data-service/issues/12][#12]]           | 3 Days          | 2 Days         | Done (By Madhavi)     | Thirumal, Sripathi,      |   |   |
|      |                        |               |                 |                |                       | Madhavi                  |   |   |
|------+------------------------+---------------+-----------------+----------------+-----------------------+--------------------------+---+---|
