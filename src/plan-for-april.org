...
|------+--------------------------+---------------+-----------------+---------------+-------------+--------------------|
|   3. | Implementation           |               | 1 Week          | 6 Days        | Done        | Development Team   |
|      | 3.1. Discipline          | [[https://github.com/vlead/lab-data-service/issues/19][#19]]           | 2 Days          | Done          | Done        | Sanchita           |
|      | 3.2. Developer           | [[https://github.com/vlead/lab-data-service/issues/16][#16]]           | 2 Days          | Done          | Done        | Reena              |
|      | 3.3. Institute           | [[https://github.com/vlead/lab-data-service/issues/18][#18]]           | 2 Days          | Done          | Done        | Sanchita           |
|      | 3.4. Asset               | [[https://github.com/vlead/lab-data-service/issues/15][#15]]           | 2 Days          | Done          | Done        | Mrudhvika          |
|      | 3.5. Hosting Information | [[https://github.com/vlead/lab-data-service/issues/17][#17]]           | 2 Days          | Done          | Done        | Reena              |
|      | 3.6. Integration Status  | [[https://github.com/vlead/lab-data-service/issues/14][#14]]           | 2 Days          | Done          | Done        | Mrudhvika          |
|------+--------------------------+---------------+-----------------+---------------+-------------+--------------------|
|   4. | Data Model Review        | [[https://github.com/vlead/lab-data-service/issues/12][#12]]           | 0.5 Day         | In Progress   | In Progress | Madhavi            |
|------+--------------------------+---------------+-----------------+---------------+-------------+--------------------|
|   5. | Implementation Review    | [[https://github.com/vlead/lab-data-service/issues/12][#12]]           | 2 Days          | In Progress   | In Progress | Madhavi            |
|------+--------------------------+---------------+-----------------+---------------+-------------+--------------------|
