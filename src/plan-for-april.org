...
|------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------+--------------------------------+------------------------------+----------------------------+-----------------------------|
|    3 | Implementation : includes end to end implementation across all layers, CRUD operations (Objects,persistence,system,REST), unit test cases, integration of Lab with other entities. | [[https://github.com/vlead/lab-data-service/issues/5][#5]] , [[https://github.com/vlead/lab-data-service/issues/6][#6]] , [[https://github.com/vlead/lab-data-service/issues/7][#7]] , [[https://github.com/vlead/lab-data-service/issues/9][#9]] , [[https://github.com/vlead/lab-data-service/issues/10][#10]] | 1.5 Months                     | 2 Months                     | In Progress                | Development Team            |
|      |                                                                                                                                                                                    |                         |                                |                              |                            |                             |
