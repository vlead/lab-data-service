...
|------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------+--------------------------------+------------------------------+----------------------------+-----------------------------|
|    3 | Implementation : includes end to end implementation across all layers, CRUD operations (Objects,persistence,system,REST), unit test cases for all, integration with other entities. | [[https://github.com/vlead/lab-data-service/issues/5][#5]] , [[https://github.com/vlead/lab-data-service/issues/6][#6]] , [[https://github.com/vlead/lab-data-service/issues/7][#7]] , [[https://github.com/vlead/lab-data-service/issues/9][#9]] , [[https://github.com/vlead/lab-data-service/issues/10][#10]] | 1.5 Months                     | 2 Months                     | In Progress                | Development Team            |
|      |                                                                                                                                                                    |                         |                                |                              |                            |                             |
|      | 1. Lab                                                                                                                                                             |                         | 3 Days                         | 4 Days                       | Done                       | Sripathi,Madhavi            |
|      | 2. Experiment                                                                                                                                                      |                         | 3 Days                         | 3 Days                       | Done                       | Sripathi,Madhavi            |
|      | 3. Discipline                                                                                                                                                      |                         | 5 Days                         | 7 Days                       | Done                       | Balamma                     |
|      | 4. Developer                                                                                                                                                       |                         | 7 Days                         | 10 Days                      | Done                       | Reena                       |
|      | 5. Institute                                                                                                                                                       |                         | 4 Days                         | 7 Days                       | Done                       | Sanchita                    |
|      | 6. Asset                                                                                                                                                           |                         | 3 Days                         | 4 Days                       | In Progress                | Sanchita,Mrudhvika          |
|      | 7. Hosting Information                                                                                                                                             |                         | 3 Days                         | 3 Days                       | In Progress                | Reena                       |
|      | 8. Integration Status                                                                                                                                              |                         | 3 Days                         | 3 Days                       | In Progress                | Reena                       |
|------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------+--------------------------------+------------------------------+----------------------------+-----------------------------|
